...
public:
    SystemSimulation(){
        ...
        _consumer->setInitReferenceState(stateReference);
...
//        float x,y,z;
//        x = _consumer->getCurrentState()(3);
//        y = _consumer->getCurrentState()(4);
//        z = _consumer->getCurrentState()(5);
    };
    ...
    void simulate(){
       ...
       // std::cout<< referenceStateConsumer<< std::endl;
       // std::cout<< StateConsumer<< std::endl;
        int numLimit=6;
        ...
        while(time<=_simulationTime) {
            ...
            numLimit = 6;//numbersOfVisibleSatellites.size();
            ...
            t.push_back(time);
            x.push_back(StateConsumer(0));
            y.push_back(StateConsumer(1));
